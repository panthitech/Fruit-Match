package com.puzzle.bubble.shooter.colors.juicymatch.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final int INIT_COIN = 100;

    public static final String DATABASE_NAME = "game_data.db";
    public static final int DATABASE_VERSION = 1;

    public static final String STAR_TABLE_NAME = "STAR_TABLE";
    public static final String STAR_TABLE_COLUMN_LEVEL_NAME = "Level";
    public static final String STAR_TABLE_COLUMN_STAR_COUNT = "Star";

    public static final String ITEM_TABLE_NAME = "ITEM_TABLE";
    public static final String ITEM_TABLE_COLUMN_ITEM_NAME = "Name";
    public static final String ITEM_TABLE_COLUMN_ITEM_COUNT = "Number";
