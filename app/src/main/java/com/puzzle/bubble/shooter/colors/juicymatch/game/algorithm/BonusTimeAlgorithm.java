...
import com.puzzle.bubble.shooter.colors.juicymatch.game.effect.TextEffect;
import com.puzzle.bubble.shooter.colors.juicymatch.game.effect.flash.TransformFlashEffectSystem;
...
public class BonusTimeAlgorithm extends BaseAlgorithm implements TouchEventListener {
    ...
    public BonusTimeAlgorithm(Engine engine, TileSystem tileSystem) {
        ...
        mSkipText = new SkipText(engine, 1500, 800, "Tap to skip");
